...
Перейдите в Supabase Dashboard → SQL Editor и выполните следующие запросы:
...
### 10. Включение RLS и создание политик
```sql
...
### 11. Создание storage bucket для чеков
```sql
INSERT INTO storage.buckets (id, name, public) VALUES ('receipts', 'receipts', false) ON CONFLICT (id) DO NOTHING;
```

### 12. Storage политики для чеков
```sql
